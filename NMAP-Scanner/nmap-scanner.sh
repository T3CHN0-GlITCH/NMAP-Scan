...
# Author Name :- AnonUser
# Date  :- 12/04/2020
# Note :- Please DON'T USE FOR WRONG INTENSION just use for EDUCATIONAL PURPOSE.
...
echo -e
echo -e
echo -e "\e[91;1mBy : AnonUser\e[0m"
echo -e 
...
while true; do
  ...
  case $yn in
  [Yy]* ) break;;
  [Nn]* )  echo && echo -e "\e[1;91mThanks for using Tool.Use for Educational purpose only. \e[1;93mGithub Repository link : \e[1;94m' https://github.com/T3CHN0-GlITCH'." ;exit;;
...
if [ "$options" = "$twentytwo" ]
  ...
  then
      ...
      echo
      echo
      echo -e "\e[24;37mAUTHOR NAME : \e[1;4;91mAnonUser\e[0m" 
      echo -e

      echo -e "\e[37mTOOL NAME : \e[4;91mNMAP Scanner\e[0m"
      echo -e
    
      echo -e "\e[37mDATE : \e[4;91m12/04/2020\e[0m"
      echo -e
 
      echo -e "\e[37mGITHUB : \e[4;91mhttps://github.com/T3CHN0-GlITCH\e[0m"
      echo -e
